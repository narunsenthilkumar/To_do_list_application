    ...
    return [
      ...
      },
      {
        ...
        tasks: [
          ...
          { id: 'chk-3', title: 'Review today’s Top 3 priorities in Taskora', completed: false, priority: 'high', dueDate: getTodayDateString(), dueTime: '08:30', projectId: 'proj-daily', tags: ['daily', 'routine'], notes: 'Pick the most impactful goals', createdAt: nowISO, updatedAt: nowISO, subtasks: [], activityLogs: [], order: 2 },
          { id: 'chk-4', title: '25-minute deep focus block without phone distraction', completed: false, priority: 'high', dueDate: getTodayDateString(), dueTime: '10:00', projectId: 'proj-daily', tags: ['daily', 'routine'], notes: 'Use Taskora Focus timer', createdAt: nowISO, updatedAt: nowISO, subtasks: [], activityLogs: [], order: 3 },
